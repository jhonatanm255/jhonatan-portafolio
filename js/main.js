...
function openModal(project) {
    ...
    if (project === 'app') {
        ...
        modalImage.src = '/img/app\ resident.png';  // Asegúrate de que la ruta de la imagen sea correcta
        projectURL = 'https://jhonatanm255.github.io/App-Nunoa/#'; // URL del proyecto
        ...
        modalImage.src = '/img/dashboard.png';  // Asegúrate de que la ruta de la imagen sea correcta
        projectURL = 'https://jhonatanm255.github.io/dashboard/'; // URL del proyecto
        ...
        modalImage.src = '/img/samel.png';  // Asegúrate de que la ruta de la imagen sea correcta
        projectURL = 'https://jhonatanm255.github.io/samel/'; // URL del proyecto
        ...
        modalImage.src = '/img/mareo.png';  // Asegúrate de que la ruta de la imagen sea correcta
        projectURL = 'https://jhonatanm255.github.io/Mareo-Music/'; // URL del proyecto
